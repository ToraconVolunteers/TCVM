...
public class AdminLoginUI extends javax.swing.JFrame {
    ...
    public AdminLoginUI(String toCase) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrative privileges required to proceed");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        boolean pass;
        pass = checkLogin(usernameTextField.getText(),passwordField.getPassword());
        if (pass == true) {
            dispose();
            switch (isCase) {
                case "more":
            ...
            Sys.Core.Util.Logger.appendLog(Sys.Core.Util.DateAndTime.getDateAndTime()+" - Warning: Someone tried to hack "+MainUI.getSelection()+"'s profile");
            JOptionPane.showMessageDialog(null, "Please input valid username and password", "Error: Invalid Credentials", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_okButtonActionPerformed

    boolean checkLogin(String username, char[] password) {
        String correctUsername = "admin";  // username
        char[] correctPassword = { '1', '2', '3', '4'}; // password
        if (username.equals(correctUsername) && Arrays.equals(password, correctPassword)) {
            Arrays.fill(password, '*'); // condom
            return true;
        } else {
            return false;
        }
...
//            public void run() {
//                new AdminLoginUI(kite).setVisible(true);
//            }
//        });
    }
